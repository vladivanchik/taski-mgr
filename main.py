...
sel_num = input("Выберите водителя из списка: " + str(users) + "\nЧтобы перейти в режим добавления пользователей введите \"Добавить нового пользователя\"(можно и с маленькой буквы) ")
...
def add_new_user():
    if sel_num.lower() == "добавить нового пользователя":
        ...
        back = input("Чтобы отменить это действия просто нажмите \"Enter\" \nЕсли вы всё-таки хотите добавить нового пользователя введите \"Добавить\"(можно с маленькой буквы) ")
